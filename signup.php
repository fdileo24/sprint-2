...
<body>
    ...
    if (empty($_POST["mailSignUp"])):?> placeholder="E-mail" <?php else:?> value=<?=$_POST["mailSignUp"];?> <?php endif;?>  name="mailSignUp">
        ...
        <!-- Password -->
        <input type="password" id="defaultRegisterFormPassword" class="form-control mb-4 " placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock" name="passwordSignup">
        <!-- RePassword -->
        <input type="password" id="defaultRegisterFormPassword" class="form-control mb-4 " placeholder="Confirma el password" aria-describedby="defaultRegisterFormPasswordHelpBlock" name="repasswordSignup">
